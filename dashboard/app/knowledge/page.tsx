...
export default function KnowledgePage() {
  ...
  return (
    <div className="space-y-7 pb-16">
      ...
      <RetrievalPipeline searching={busy === 'search'} sourceCount={selected.length || documents.length} chunkCount={chunks} />
